        ...
        MaterialApp(
          home: Builder(
            builder: (context) {
              ...
              // Test con base = 8.0
              final padding8 = getResponsivePadding(context, base: 8.0);
              expect(padding8, equals(16.0)); // 8.0 × 2.0

              // Test con base = 24.0
              final padding24 = getResponsivePadding(context, base: 24.0);
        ...
        MaterialApp(
          home: Builder(
            builder: (context) {
              ...
              final spacing = getResponsiveSpacing(context, base: 12.0);
        ...
        MaterialApp(
          home: Builder(
            builder: (context) {
              ...
              final fontSize = getResponsiveFontSize(context, base: 16.0);
        ...
        MaterialApp(
          home: Builder(
            builder: (context) {
              ...
              // Título (20.0) → 22.5
              final titleSize = getResponsiveFontSize(context, base: 20.0);
              expect(titleSize, equals(22.5));

              // Body (14.0) → 15.75
              final bodySize = getResponsiveFontSize(context, base: 14.0);
              expect(bodySize, equals(15.75));

              // Caption (12.0) → 13.5
              final captionSize = getResponsiveFontSize(context, base: 12.0);
        ...
        MaterialApp(
          home: Builder(
            builder: (context) {
              ...
              expect(getResponsivePadding(context, base: 0.0), equals(0.0));
              expect(getResponsiveSpacing(context, base: 0.0), equals(0.0));
              expect(getResponsiveFontSize(context, base: 0.0), equals(0.0));
        ...
        MaterialApp(
          home: Builder(
            builder: (context) {
              ...
              expect(getResponsivePadding(context, base: -10.0), equals(-20.0));
        ...
        MaterialApp(
          home: Builder(
            builder: (context) {
              ...
              final largePadding = getResponsivePadding(context, base: 1000.0);
